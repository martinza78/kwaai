            ...
            function registerSchemaRoute(options,callback){
                ...
                options.preMW.push(
                    function (req,res,next) {
                        req.kwaaioptions = {collection: options.collection, schema: options.schema,validate:false,coerce:false};
                        if (options.fail) {
                ...
                app.get(route,[].concat(options.preMW).concat(options.preReadMW).concat(webcrudtools.getByQuery).concat(options.postMW));
                app.post(route,[].concat(options.preMW).concat([webcrudtools.validateData,webcrudtools.coerceData]).concat(options.preCreateMW).concat(webcrudtools.insert).concat(options.postMW));
                app.options(route,function(req,res){sendOptions(res,["GET","POST"],options.schema);});


                app.get(route+"/:id",[].concat(options.preMW).concat(options.preReadMW).concat(webcrudtools.getById).concat(options.postMW));
                app.put(route+"/:id",[].concat(options.preMW).concat([webcrudtools.validateData,webcrudtools.coerceData]).concat(options.preUpdateMW).concat(webcrudtools.updateFull).concat(options.postMW));
                app.patch(route+"/:id",[].concat(options.preMW).concat([webcrudtools.validateData,webcrudtools.coerceData]).concat(options.preUpdateMW).concat(webcrudtools.updatePart).concat(options.postMW));
                app.delete(route+"/:id",[].concat(options.preMW).concat(options.preDeleteMW).concat(webcrudtools.delete).concat(options.postMW));

    ...
    createApiExpress:
        function(apiOptions)
        {
            ...
            if (apiOptions&&apiOptions.tenantOptions){
                ...
                app.get("/admin/" + apiOptions.tenantOptions.plural,webcrudtools.onlyForRoles([apiOptions.tenantOptions.adminRole]),loadedTenantTools.getTenantsByQuery);
                app.post("/admin/" + apiOptions.tenantOptions.plural,webcrudtools.onlyForRoles([apiOptions.tenantOptions.adminRole]),loadedTenantTools.checkTenantExists,loadedTenantTools.createTenant);
                app.get("/:" +  apiOptions.tenantOptions.name + "/users",webcrudtools.onlyForRoles([apiOptions.tenantOptions.tenantAdminRole]),loadedTenantTools.getUsers);
                //app.post("/:" + apiOptions.tenantOptions.name + "/users",webcrudtools.onlyForRoles([apiOptions.tenantOptions.tenantAdminRole]),loadedTenantTools.createUser);
                app.post("/:" + apiOptions.tenantOptions.name + "/users",loadedTenantTools.createUser);
            }

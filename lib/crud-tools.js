    ...
    getById:
     ...
     ,getByQuery:
        function(options,callback){
            ...
            try{
                var query=mquery(options.collection).find();
                if(options.query){mongotools.buildQueryFromOptions(query,options.query)}
     ...
     ,insert:
        function(options,callback)
        {
            ...
            try{
                ...
                options.collection.insert(options.data,{safe: true},documentInserted);
            }catch(exp){
                 return callback(exp);
            }
        }
     ...
     ,delete:
        function(options,callback)
        {
            ...
            try {
                ...
                var query=mquery(options.collection).find({_id:id});
                if(options.query){
